...
class AttendanceRecorder {
    constructor() {
        this._attendanceInterval = 60; // 1 min
    ...
    recordAttendance(correlationId, state, callback) {
...
exports.AttendanceRecorder = AttendanceRecorder;
//# sourceMappingURL=AttendanceRecorder.js.map